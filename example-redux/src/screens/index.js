...
import PushedScreenNoToolbar from './PushedScreenNoToolbar'
...
export function registerScreens(store, Provider) {
  ...
  Navigation.registerComponent('example.PushedScreenNoToolbar', () => PushedScreenNoToolbar, store, Provider);
}
